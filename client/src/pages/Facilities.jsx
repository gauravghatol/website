...
const Facilities = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-ssgmce-blue to-ssgmce-dark-blue py-10 sm:py-12 md:py-14 lg:py-16">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative mx-auto w-full max-w-[120rem] px-4 sm:px-5 md:px-6">
          <nav className="mb-4 text-sm text-blue-200">
            <span>Home</span>
            <span className="mx-2">/</span>
            <span className="text-white">Facilities</span>
          </nav>
          <h1 className="text-[clamp(1.6rem,4.2vw,2.25rem)] font-bold text-white">Campus Facilities</h1>
          <p className="mt-4 text-[clamp(0.95rem,2vw,1.25rem)] text-blue-100">
