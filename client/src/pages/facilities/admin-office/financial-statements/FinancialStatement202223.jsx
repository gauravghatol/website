...
const FinancialStatement202223 = () => {
  return (
    <AdminOfficePageLayout
      title="Financial Statement 2022-23"
      pdfLink="/documents/admin-office/financial-statements/College Financial Statement 2022-23.pdf"
      pdfTitle="Financial Statement 2022-23"
    >
      <div className="space-y-6">
        <div className="flex items-center gap-3 border-b border-gray-200 pb-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Financial Statement 2022-23</h2>
        ...
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-5">
          <p className="text-gray-700">
            Audited financial statement for the financial year 2022-23.
          </p>
        </div>
...
export default FinancialStatement202223;
