...
const FinancialStatement202324 = () => {
  return (
    <AdminOfficePageLayout
      title="Balance Sheet 2023-24"
      pdfLink="/documents/admin-office/financial-statements/BALANCE SHEET 2023-24.pdf"
      pdfTitle="Balance Sheet 2023-24"
    >
      <div className="space-y-6">
        <div className="flex items-center gap-3 border-b border-gray-200 pb-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Balance Sheet 2023-24</h2>
        ...
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-5">
          <p className="text-gray-700">
            Audited balance sheet and financial statement for the financial year 2023-24.
          </p>
        </div>
...
export default FinancialStatement202324;
