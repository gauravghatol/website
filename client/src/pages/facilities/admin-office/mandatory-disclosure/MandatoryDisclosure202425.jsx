...
const MandatoryDisclosure202425 = () => {
  return (
    <AdminOfficePageLayout
      title="Mandatory Disclosure 2024-25"
      pdfLink="/documents/admin-office/mandatory-disclosure/Mandatory Disclosure_2024-25.pdf"
      pdfTitle="Mandatory Disclosure 2024-25"
    >
      <div className="space-y-6">
        <div className="flex items-center gap-3 border-b border-gray-200 pb-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Mandatory Disclosure 2024-25</h2>
        ...
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-5">
          ...
          <p className="text-gray-700">
            ...
            comprehensive information about the institute for the academic year 2024-25.
          </p>
        </div>
...
export default MandatoryDisclosure202425;
