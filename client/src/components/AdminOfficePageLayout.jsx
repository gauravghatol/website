...
const AdminOfficePageLayout = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-ssgmce-blue to-ssgmce-dark-blue py-12 sm:py-14 md:py-16">
        ...
        <div className="relative mx-auto w-full max-w-[120rem] px-4 sm:px-5 md:px-6">
          ...
          <h1 ref={heroRef} className="text-[clamp(1.6rem,4.2vw,2.25rem)] font-bold text-white">{pageTitle}</h1>
        </div>
      </div>
