...
const TBtn = ({ icon: Icon, label, title, onClick, accent, disabled, uploading }) => (
  <button
    ...
    className={`
      ...
      ${disabled ? "opacity-40 cursor-not-allowed" : "hover:bg-gray-100 active:bg-gray-200 cursor-pointer"}
      ${accent ? "bg-blue-50 border border-blue-300 text-blue-700 hover:bg-blue-100" : "bg-white border border-gray-300"}
    `}
  >
    {uploading ? (
...
const MarkdownEditor = ({
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {/* Toolbar */}
      <div className="flex items-center gap-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded-t-lg flex-wrap">
        {/* ── Text formatting ── */}
      ...
      <div className="flex items-center gap-2 mt-2">
        ...
        {(uploadingImage || uploadingFile) && (
          <span className="text-xs text-blue-600 flex items-center gap-1.5 ml-2">
            <div className="w-3 h-3 border-2 border-blue-500 border-t-transparent rounded-full animate-spin" />
            Uploading…
          </span>
        )}
