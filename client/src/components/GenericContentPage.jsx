...
const GenericContentPage = ({ pageId }) => {
  ...
  return (
    <GenericPage title={displayPage.pageTitle} sidebar={sidebar}>
      {/* Page Title - Editable */}
      {isEditing ? (
        <div className="mb-4">
            ...
            <div className="page-section">
              ...
              {section.type === 'list' && (
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  {section.content.items?.map((item, idx) => (
                    <li key={idx}>
                      <EditableText path={`sections[${index}].content.items[${idx}]`} element="span" />
                    </li>
                  ))}
                </ul>
              )}
                ...
                <figure className="my-6">
                  ...
                  {section.content.caption && (
                    <figcaption className="text-sm text-gray-500 mt-2 text-center italic">
                      <EditableText path={`sections[${index}].content.caption`} element="span" />
                    </figcaption>
                  )}
                </figure>
              )}
