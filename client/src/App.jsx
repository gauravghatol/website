      ...
      >
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route
                path="/facilities/other/transportation"
                element={
                  <Layout>
                    <Transportation />
                  </Layout>
              ...
              />
              <Route
                path="/facilities/other/services"
                element={
                  <Layout>
                    <OtherServices />
                  </Layout>
              ...
              {/* Computing Facility Routes */}
              <Route
                path="/facilities/computing/labs"
                element={
                  <Layout>
                    <ComputerLabs />
                  </Layout>
              ...
              />
              <Route
                path="/facilities/computing/software"
                element={
                  <Layout>
                    <SoftwareTools />
                  </Layout>
              ...
              />
              <Route
                path="/facilities/computing/network"
                element={
                  <Layout>
              ...
              />
              <Route
                path="/facilities/computing/support"
                element={
                  <Layout>
                    <SupportPolicies />
                  </Layout>
