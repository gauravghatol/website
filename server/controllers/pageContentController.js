...
const departmentPages = [
  ...
  },
  {
    ...
    templateData: {
      ...
      hodPhoto:
        "/src/assets/images/departments/electrical/HOD_ELECTRICAL.jpg",
              ...
              cards: [
                {
                  ...
                  description:
                    "To acquire autonomous status for the institute.",
                },
                {
            ...
            content: {
              cards: [
                ...
                },
                {
                  title: "Equality",
                  description:
                    "All beings are equal in the eyes of the divine.",
                  icon: "FaBalanceScale",
                  color: "orange",
                },
                {
              ...
              cards: [
                {
                  ...
                  description:
                    "Parent body providing overall guidance and support",
                  icon: "FaBuilding",
                  color: "orange",
                },
                {
                ...
                },
                {
                  title: "HODs",
                  description:
                    "Department Heads managing respective departments",
                  icon: "FaUserGraduate",
                  color: "blue",
                },
              ],
...
const autoSeedMissingPages = async () => {
  try {
    ...
    if (created > 0 || updated > 0) {
      console.log(`[Auto-Seed] Created ${created} missing page(s), updated ${updated} empty page(s).`);
    }
  } catch (error) {
...
const resetPageToVersion = async (req, res) => {
  try {
    ...
    if (!log.previousData) {
      return res.status(400).json({ success: false, message: "No previous data snapshot available for this log entry" });
    }
    ...
    const immutableFields = new Set(["_id", "__v", "createdAt", "updatedAt", "lastEditedBy", "pageId"]);
